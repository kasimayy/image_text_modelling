...
folder = "/vol/medic02/users/ag6516/image_text_modelling/data/chestx/text_reports/raw" # or wherever you've moved them all
...
with open('./data/chestx/MeSH/original/openi.mesh') as fr:
    lines = fr.readlines()
...
for line in lines:
    ...
    #print imagid
    mesh = linel[1].lstrip().rstrip().lower().replace('/',' ')
    #print caption
    mesh_ = {}
...
for k,v in mesh_reports.iteritems():
